    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200/80 pb-5">
        <div class="space-y-1">
            ...
            <p class="text-xs text-slate-500">
                Curate the public portfolio grid shown on the website gallery page.
            </p>
        </div>
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div class="relative w-full sm:max-w-xs">
            ...
            <input
                ...
                placeholder="Filter gallery items..."
            ...
            <table class="w-full caption-bottom text-xs">
                <thead class="[&_tr]:border-b border-slate-200 bg-slate-50/70">
                    <tr class="border-b transition-colors">
                        <th class="h-10 px-4 text-left align-middle font-medium text-slate-500 text-xs">Item</th>
                ...
                <tbody class="[&_tr:last-child]:border-0 divide-y divide-slate-100">
                    @forelse($this->galleries as $item)
                        ...
                        <tr>
                            <td colspan="4" class="p-8 text-center text-slate-500">
                                <div class="max-w-xs mx-auto flex flex-col items-center">
                                    ...
                                    <p class="text-sm font-medium text-slate-900">No gallery items found</p>
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
                ...
                <div class="flex flex-col space-y-1.5 text-left">
                    ...
                    <p class="text-xs text-slate-500">
                        {{ $isEditing ? 'Make changes to the portfolio item details and publish state.' : 'Add a new verified project photo to the public gallery grid.' }}
                    </p>
                </div>
                ...
                >
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input
                            ...
                            id="title"
                            wire:model="title"
                            placeholder="Executive Sweeping Protocol"
                    ...
                    <!-- Category -->
                    <div class="space-y-1.5">
                        <label for="gallerycategory_id" class="text-xs font-medium leading-none text-slate-900">
                            Category <span class="text-rose-500">*</span>
                        </label>
                        <select
                            id="gallerycategory_id"
                            wire:model="gallerycategory_id"
                            class="flex h-9 w-full rounded-md border border-slate-200 bg-transparent px-3 py-1 text-xs shadow-xs transition-colors placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950"
                        >
                    ...
                    <div class="space-y-1.5">
                        <label for="image" class="text-xs font-medium leading-none text-slate-900">
                            Image <span class="text-rose-500">*</span>
                        </label>
                        <div
                        ...
                        >
                            <!-- Dropzone / File Input -->
                            <div
                                class="relative flex flex-col items-center justify-center gap-2 rounded-lg border border-dashed border-slate-300 bg-slate-50/50 p-6 text-center transition-colors"
                            ...
                            >
                                @if($this->imagePreview())
                                    <img src="{{ $this->imagePreview() }}" alt="Image preview" class="h-32 w-full object-cover" />
                                @else
                    ...
                    <div class="flex items-center justify-between rounded-md border border-slate-200 p-3 bg-slate-50/50">
                        <div class="space-y-0.5">
                            ...
                            <p class="text-[11px] text-slate-500">Display this item in the public gallery grid</p>
                        </div>
            ...
            >
                <div class="space-y-2">
                    ...
                    <p class="text-xs text-slate-500 leading-relaxed">
                        This action cannot be undone. This will permanently delete this portfolio item from the database and remove it from the public gallery grid.
                    </p>
                </div>
