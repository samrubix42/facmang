<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200/80 pb-5">
        <div class="space-y-1">
            ...
            <p class="text-xs text-slate-500">
                Create a new commercial facility service for the public catalog.
            </p>
        </div>
    ...
    <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-xs">
        ...
        >
            ...
            <!-- Content (TinyMCE) -->
            <div class="space-y-1.5">
                <label for="service_add_content" class="text-xs font-medium leading-none text-slate-900">
            ...
            <div class="flex items-center justify-end gap-2 pt-3 border-t border-slate-100">
                ...
                <button
                    ...
                    wire:loading.attr="disabled"
                    class="inline-flex h-9 items-center justify-center rounded-md border border-slate-200 bg-white px-3 py-2 text-xs font-medium text-slate-700 shadow-xs hover:bg-slate-100 hover:text-slate-900 transition-colors cursor-pointer disabled:opacity-50"
                >
                    Save &amp; Add Another
                </button>
                <button
